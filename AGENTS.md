...
- `sam/src/project.py`: main speech loop, hotkey handling, transcription, LLM call, and playback.
...
## Sam Notes
- The voice assistant is macOS-oriented and uses local audio plus global keyboard hotkeys.
- The current record hotkey is `9`; release stops recording, and `q` quits.
