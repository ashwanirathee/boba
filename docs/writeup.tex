...
When global hotkeys are available, the assistant uses \texttt{9} as the hold-to-record key and \texttt{q} to quit. If macOS accessibility permissions are unavailable, the system falls back to typed commands in the terminal.
